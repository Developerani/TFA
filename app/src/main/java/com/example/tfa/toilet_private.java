 ...
 */
public class toilet_private extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_toilet_private, container, false);
...
//                Log.d("TAG", "Value is: " + marker.getTitle());
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null){
                    ...
                    SupportMapFragment mapFragment = (SupportMapFragment)getChildFragmentManager().findFragmentById(R.id.private_toilet);
                    mapFragment.getMapAsync(toilet_private.this);
                }
            }
        });
    }
